...
| `packaging-product-identity-label-lock-board` | `D:\AI\skill\packaging-product-identity-label-lock-board` | Request a horizontal 16:9 packaging board and complete prompt pair; the fixed-owner AI-video Project Canon bridge exports geometry by default and adds `label_copy` only after exact-copy evidence passes. | `D:\AI视觉工作室\.agents\skills\packaging-product-identity-label-lock-board` | Active |
