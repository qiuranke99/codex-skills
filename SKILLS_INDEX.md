...
| `scene-canon-asset-pack` | `D:\AI\skill\scene-canon-asset-pack` | Build a neutral, internally consistent Scene Canon pack with independent plates and finalized prompts, then optionally export each approved scene authority through the fixed-owner AI-video Project Canon bridge. | `D:\AI视觉工作室\.agents\skills\scene-canon-asset-pack` | Active |
| `multi-angle-product-identity-lock-board` | `D:\AI\skill\multi-angle-product-identity-lock-board` | Request a horizontal 16:9 six-view opaque-product board, publish the complete prompt pair, and optionally export the approved product-geometry authority through the fixed-owner AI-video Project Canon bridge. | `D:\AI视觉工作室\.agents\skills\multi-angle-product-identity-lock-board` | Active |
| `packaging-product-identity-label-lock-board` | `D:\AI\skill\packaging-product-identity-label-lock-board` | Build an OCR-first, rotation-ready independent-master packaging asset pack with deterministic exact-copy/code composition, evidence-bound QA, live final-runtime gating, and COMPLETE-run-bound Canon label authority. | `D:\AI视觉工作室\.agents\skills\packaging-product-identity-label-lock-board` | Active |
| `material-sensitive-product-master-asset-board` | `D:\AI\skill\material-sensitive-product-master-asset-board` | Request one horizontal 16:9 material master board, publish the complete material-preserving prompt pair, and optionally export product geometry plus material behavior through the fixed-owner AI-video Project Canon bridge. | `D:\AI视觉工作室\.agents\skills\material-sensitive-product-master-asset-board` | Active |
