...
| `ai-visual-director` | `D:\AI\skill\ai-visual-director` | Story-first AI visual director for product-ad briefs, product images, and visual references; produces storyboard image deliverables and concise Google Omni/Veo video prompts while keeping route, story, shot-plan, and QC artifacts internal. | `https://github.com/qiuranke99/ai-visual-director-skill` | active |
