...
| `material-sensitive-product-master-asset-board` | `D:\AI\skill\material-sensitive-product-master-asset-board` | Request one horizontal 16:9 material master board, freeze source semantics and critical invariants, require direct source-to-board observations, deterministically freeze QA/handoff/accepted records, reject cross-panel topology drift, and publish the complete material-preserving prompt pair. | `D:\AI视觉工作室\.agents\skills\material-sensitive-product-master-asset-board` | Active |
