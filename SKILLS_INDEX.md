...
| `single-face-character-lock-board` | `D:\AI\skill\single-face-character-lock-board` | Generate and inspect the one-face/headless-body board directly; preserve identity, accepted prompt bytes, complete prompt-pair delivery, and explicit authority promotion without worker or Codex database prerequisites. | `D:\AI视觉工作室\.agents\skills\single-face-character-lock-board` | Active |
...
| `cinematic_world_builder` | `D:\AI\skill\cinematic_world_builder` | Build a coherent cinematic world and nine distinct film-still prompts by default, honoring the user's chosen count, style, aspects, and output format. | `D:\AI视觉工作室\.agents\skills\cinematic_world_builder` | Active |
...
| `multi-angle-product-identity-lock-board` | `D:\AI\skill\multi-angle-product-identity-lock-board` | Generate and inspect one low-risk six-view product board directly; preserve source limits, accepted prompt bytes, complete prompt-pair delivery, and geometry-only authority without worker or Codex database prerequisites. | `D:\AI视觉工作室\.agents\skills\multi-angle-product-identity-lock-board` | Active |
