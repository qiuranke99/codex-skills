...
5. 用新机器 `<SYSTEM_ROOT>/docs/CODEX_PROMPTS.md` 的“恢复中断或换电脑”Prompt 恢复。
6. 仅在验证通过后继续下一阶段。
...
4. 确认 13 个核心 Skill 可发现且彼此相邻。
5. 验证 Python、Pillow、FFmpeg、ffprobe 和 Image Generation。
6. 设置 `<SYSTEM_ROOT>` 并使用其 `docs/CODEX_PROMPTS.md` Master Prompt。
