...
公开维护的个人 Codex Skill 源码仓库。当前保留 **20 个独立包**，每包只维护一个当前版本。机器清单为 [SKILLS_MANIFEST.json](SKILLS_MANIFEST.json)，用途索引为 [SKILLS_INDEX.md](SKILLS_INDEX.md)。源码存在不等于已在某台机器安装。
...
python .github/scripts/validate_skill_inventory.py --repo-root . --expected-count 20
...
python .github/scripts/validate_standalone_skills.py --repo-root . --expected-count 20 --timeout 180 --compact
