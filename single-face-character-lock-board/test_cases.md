...
5. **One-face topology**: both Codex-board QA and external 4K QA require exactly one visible face in the bust and headless front/back body views, including no reflected or printed faces.
6. **Source bundle**: 4K handoff requires the Codex board plus the original identity, hair, skin, body, outfit, shoe, and accessory references.
...
13. **External fidelity**: external verification requires original references plus Codex board, one-face topology, runtime evidence, and a passed source-fidelity gate.
