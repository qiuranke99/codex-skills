#!/usr/bin/env python3
"""Fixed-owner atomic Project Canon writer for Previs."""
...
if __name__ == "__main__":
    raise SystemExit(run_fixed_workflow_canon_writer_cli("ai-video-timed-animatic-previs-director", Path(__file__)))
